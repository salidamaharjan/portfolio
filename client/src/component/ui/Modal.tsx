...
export function Modal({firstButtonName, modalTitle,modalBody, secondButtonName}: ModalProps) {
  return (
    <>
<button
  type="button"
...
<div
  ...
  <div
    ...
    <div
      ...
      <div
        className="relative flex-auto p-4 text-center"
        data-twe-modal-body-ref>
        <h5 className="mb-2 text-xl font-bold">Popover in a modal</h5>
        ...
        <hr className="my-4 dark:border-neutral-500" />
        <h5 className="mb-2 text-xl font-bold">Tooltips in a modal</h5>
        <p className="mb-4">
          <a
            href="#"
